...
* Será necesario ejecutar la imputación de las tablas, para esto se debera correr el siguiente comando en la terminal GitBash: <br>
    **dbt run --models imputation.*carpeta*** <br>
